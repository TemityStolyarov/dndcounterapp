...
class ColorPalette {
  ...
  static const statusProvocatedLabel = Color(0XFFB8A70B);
  ...
  static const statusRollDebuffLabel = Color(0xFFB80B0B);
  static const statusRollBuffLabel = Color(0xFFDAA00B);

  static const statusKdDebuffBackground = Color(0xFFFFE2E2);
  static const statusKdBuffBackground = Color(0xFFFBE4C1);
  static const statusProvocatedBackground = Color(0xFFFBF5C1);
  ...
  static const statusRollDebuffBackground = Color(0xFFFFE2E2);
  static const statusRollBuffBackground = Color(0xFFFBE4C1);
